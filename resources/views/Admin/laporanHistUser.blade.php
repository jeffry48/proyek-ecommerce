                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                ...
                                ?>
                                <h1>Laporan Penginap Terbanyak</h1>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                </section>
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form action="searchUserbanyak" method="get">
                                        <div class="box">
                            ...
                            <table>
                                ...
                                <tbody>
                                    @foreach ($history as $d)
                                        <tr>
                                            <?php
                                                $cust=DB::select('select * from customer where id_customer="'.$d->id_customer.'"');
                                            ?>
                                            <td>{{$cust[0]->nama_customer}}</td>
